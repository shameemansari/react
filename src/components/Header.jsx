...
export default function Header() {
  ...
  return (
    <Disclosure as="nav" className="bg-gray-800 absolute top-0 right-0 left-0 z-[1200]">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex space-x-4">
                  ...
                  { token && <NavbarLink to="/task" name="Task"/>}
...
export const NavbarLink = ({to, name}) => {
  return (<>
    <NavLink to={to} className={isActive => 'rounded-md px-3 py-2 text-sm font-medium ' + (!isActive ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white')}>
      {name}
    </NavLink>
    </>);
}
...
export const NavMenu = () => {
  ...
  <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <Menu as="div" className="relative ml-3">
              ...
              >
                <MenuItem>
                  <button onClick={clickHandler} className='block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100 data-[focus]:outline-none'>
                    Sign Out
                  </button>
                </MenuItem>
              </MenuItems>
